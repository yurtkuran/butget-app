...
const BudgetCard = ({ name, amount, max, gray, onAddExpenseClick, onViewExpennsesClick, hideButtons }) => {
    const classNames = [];
    if (amount > max) {
                ...
                <Card.Body>
                    <Card.Title className='d-flex justify-content-between align-items-baseline fw-normal mb-3'>
                        ...
                        <div className='d-flex align-items-baseline'>
                            ...
                            {max && <span className='text-muted fs-6 ms-1'>/ {currentFormatter.format(max)}</span>}
                        </div>
                    </Card.Title>
                    ...
                    {!hideButtons && (
                        <Stack direction='horizontal' gap='2' className='mt-4'>
                            ...
                            <Button variant='outline-secondary' onClick={onViewExpennsesClick}>
                                View Expenses
                            </Button>
                        </Stack>
                    )}
